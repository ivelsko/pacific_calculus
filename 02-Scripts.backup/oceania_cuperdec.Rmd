---
title: "Pacific calculus sample cumulative decay curves from nt MALT database"
author: "Irina Velsko"
...
# make Island a factor for plotting
  mutate(Island = fct_relevel(Island, "Efate","Efate_3000","Flores","Futuna","Raiatea","Rapa_Nui","Rurutu","Taumako_Duff_Islands","Tongatapu","Uripiv","Vao","Viti_Levu","Watom","modernCalculus", "subPlaque", "supPlaque", "urbanGut",  "ruralGut", "skin", "sediment", "archBone"))
...
# ggsave("./06-publication/supplemental_figures/Sup_fig_XX1/cuperdec_species_pacific.pdf", plot = cd_curve_plot, device = "pdf",
#        scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# ggsave("./06-publication/supplemental_figures/Sup_fig_XX1/cuperdec_species_pacific.png", plot = cd_curve_plot, device = "png",
#        scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
