...
type_cols <- c("Saliva - Industrial" = "#AFDFEF", , "Buccal mucosa - Industrial" = , "Plaque - Industrial" = "#FC6882", "Plaque - Non-industrial" = "#C70E7B", "Saliva - Non-industrial" = "#54BCD1", "Buccal mucosa - Non-industrial" = "#8FDA04", "Calculus - Industrial" = "#F4E3C7")
...
ggsave("./06-publication/supplemental_figures/Sup_fig_4/species_counts_raincloud.pdf", plot = pca_kegg, device = "pdf",
