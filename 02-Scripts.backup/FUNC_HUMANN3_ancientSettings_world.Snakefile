...
workdir: "/mnt/archgen/microbiome_calculus/pacific_calculus/04-Analysis/humann3/world_samples"
...
SAMPLES = {sample: "/mnt/archgen/microbiome_calculus/pacific_calculus/04-Analysis/humann3/world_samples/input/{sample}.unmapped.fastq.gz".format(sample=sample)
...
rule all:
    input: 
        expand("anc_params_output/{sample}_pathcoverage.tsv", sample=SAMPLES.keys())
...
rule metaphlan3:
    ...
    output: 
        profile = "anc_params_output/{sample}.metaphlan.profile.txt"
...
rule prepare_metaphlan3_profile:
    input:
        "anc_params_output/{sample}.metaphlan.profile.txt"
    output:
