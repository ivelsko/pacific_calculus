...
ggsave("./06-publication/supplemental_figures/Sup_fig_XX2/no_species_malt_assignment_stats.svg", plot = reads_sp, device = "svg",
       scale = 1, width = 11, height = 7, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/Sup_fig_XX2/no_species_malt_assignment_stats.pdf", plot = reads_sp, device = "pdf",
       scale = 1, width = 11, height = 7, units = c("in"), dpi = 300)
