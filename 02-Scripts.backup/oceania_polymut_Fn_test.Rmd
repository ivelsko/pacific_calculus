...
# ggsave("./06-publication/supplemental_figures/Sup_fig_12/Fn_dN_dS_test.svg", plot = fn_polymut_all, device = "svg",
...
# ggsave("./06-publication/supplemental_figures/Sup_fig_12/Fn_dN_dS_short_test.pdf", plot = Fn_plots, device = "pdf",
#         scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)

# ggsave("./06-publication/supplemental_figures/Sup_fig_12/Fn_dN_dS_short_test.svg", plot = Fn_plots, device = "svg",
...
svg(file = "./06-publication/supplemental_figures/Sup_fig_12/Fn_corr_plot.svg") 
