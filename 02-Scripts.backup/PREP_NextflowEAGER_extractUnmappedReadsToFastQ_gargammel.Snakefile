...
#### SAMPLES ###################################################################
samplelist = pd.read_csv("/mnt/archgen/microbiome_calculus/pacific_calculus/04-Analysis/inStrain/benchmarking_ancient/gargammel/pac_gargammel_eager.tsv",
                         sep="\t")
...
def list_bamfiles(wildcards):
    ...
    return " ".join([f"/mnt/archgen/microbiome_calculus/pacific_calculus/04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/mapping/bwa/{wildcards.library}_{seqtype}.mapped.bam"
...
rule all:
    input:
        "04-Analysis/inStrain/benchmarking_ancient/gargammel/PREP_Nextflow_EAGER_noReads.tsv",
        expand("04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/per_sample/{sample}.concatenated", sample=SAMPLES),
        expand("04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/collapsed/{sample}.collapsed", sample=SAMPLES)
...
rule extract_unmapped_reads:
    ...
    output:
        pe1 = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}_1.fastq.gz",
        pe2 = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}_2.fastq.gz",
        pe0 = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}_0.fastq.gz",
...
rule count_reads:
    input:
        ...
        pe0 = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}_0.fastq.gz"
    output:
        temp("04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}.n")
...
rule summarise_count_reads:
    input:
        expand("04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}.n", library=LIBRARIES)
    output:
        "04-Analysis/inStrain/benchmarking_ancient/gargammel/PREP_Nextflow_EAGER_noReads.tsv"
...
rule concatenate_samples:
    input:
        lambda wildcards: [f"04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/{library}.n" for library in samplelist.loc[samplelist['Sample_Name'] == wildcards.sample]['Library_ID'].unique().tolist()]
    output:
        touch("04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/per_sample/{sample}.concatenated")
    message: "Concatenate the FastQ files across all libraries: {wildcards.sample}"
    params:
        dir = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/per_sample"
    run:
...
rule collapse:
    input:
        "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/per_sample/{sample}.concatenated"
    output:
        touch("04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/collapsed/{sample}.collapsed")
    message: "Merge overlapping reads using fastp: {wildcards.sample}"
    conda: "ENVS_fastp.yaml"
    params:
        dir = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/per_sample",
        outdir = "04-Analysis/inStrain/benchmarking_ancient/gargammel/eager_output/fastqs/collapsed"
    shell:
        """
