...
# svg(file = "./06-publication/supplemental_figures/Sup_fig_XX7/KEGG_KO_heatmap.svg", width = 14, height = 12)
# 
# set.seed(1)
...
# ggsave("./06-publication/main_figures/Figure_XX6/ottowia_abund.pdf", plot = ott_abund, device = "pdf",
...
ggsave("./06-publication/supplemental_figures/Sup_fig_XX7/KOs_pca_clusters.pdf", plot = pca_kegg, device = "pdf",
...
# ggsave("./06-publication/supplemental_figures/Sup_fig_XX6/clusters_sp_KOs.pdf", plot = KO_sp_dots, device = "pdf",
#        scale = 1, width = 7, height = 6, units = c("in"), dpi = 300)

KO_sp_rain <- raincloud_kegg | sp_rain
KO_sp_rain

# ggsave("./06-publication/supplemental_figures/Sup_fig_XX6/clusters_sp_KOs_rain.pdf", plot = KO_sp_rain, device = "pdf",
...
# ggsave("./06-publication/supplemental_figures/Sup_fig_XX7/no_sp_cont_KOs.pdf", plot = sxx7, device = "pdf",
#        scale = 1, width = 12, height = 6, units = c("in"), dpi = 300)
